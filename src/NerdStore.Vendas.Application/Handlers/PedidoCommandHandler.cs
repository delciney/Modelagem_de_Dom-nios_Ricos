        ...
        IRequestHandler<CancelarProcessamentoPedidoCommand, bool>
    {
        ...
        public async Task<bool> Handle(AdicionarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            var pedidoItem = new PedidoItem(
                message.ProdutoId, message.Nome, message.Quantidade, 
            ...
            if (pedido == null)
            {
                ...
                pedido.AdicionarEvento(new PedidoRascunhoIniciadoEvent(
                    message.ClienteId, message.ProdutoId));
            }
            else
            {
                ...
                {
                    var item = pedido.PedidoItems
                        ?.FirstOrDefault(p => p.ProdutoId == message.ProdutoId);
            ...
            pedido.AdicionarEvento(new PedidoItemAdicionadoEvent(
                pedido.ClienteId, pedido.Id, message.ProdutoId, message.Nome, 
        ...
        private bool ValidarComando(Command message)
        {
            ...
            {
                _mediatorHandler.PublicarNotificacao(new DomainNotification(
                    message.MessageType, error.ErrorMessage));
            }
